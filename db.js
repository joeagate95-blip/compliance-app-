...
function defaultDb(){
 ...
 return {
  ...
  properties:[{
    id:propertyId,
    address:'12 King Street, Manchester, M1 1AA',
    type:'3 Bedroom Semi-Detached',
    landlordId:users[0].id,
    agentId:'',
    tenantIds:[users[3].id],
    status:'Compliant',
    lastConditionReview:'2026-05-12',
    nextConditionReview:'2026-11-12'
  }],
  contractors:[
    {
      id:uuid(),
      trade:'Gas',
      company:'Ratcliffe & Sons Ltd',
      contactName:'Joseph Agate',
      email:'contractor@demo.co.uk',
      phone:'01234 567890',
    ...
    },
    {
      ...
      contactName:'A. Smith',
      email:'electrician@example.co.uk',
      phone:'01234 567891',
  ...
  documents:[
    {
      ...
      status:'Valid',
      fileName:'demo-cp12.pdf',
      notes:'Annual gas safety record stored.'
    },
    {
      id:uuid(),
      propertyId,
      ...
      status:'Valid',
      fileName:'demo-eicr.pdf',
      notes:'Satisfactory EICR.'
    },
    {
      id:uuid(),
      propertyId,
      category:'PAT Testing',
      title:'PAT Testing Record',
      expiryDate:'2027-03-20',
      issueDate:'2026-03-20',
      status:'Valid',
      fileName:'demo-pat.pdf',
      notes:'Portable appliance checks completed.'
    },
    {
      id:uuid(),
      propertyId,
      category:'Tenant Contracts',
      title:'Signed AST Agreement',
      expiryDate:'2027-04-01',
      issueDate:'2026-04-01',
      status:'Stored',
      fileName:'demo-ast.pdf',
      notes:'Signed tenant agreement.'
    }
  ],
  reviews:[
    {
      ...
      propertyId,
      date:'2026-05-12',
      completedBy:'Joseph Agate',
      outcome:'Good Condition',
      notes:'Property clean and well maintained. No visible damp or mould. Smoke and CO alarms tested.',
      photos:[]
    }
  ],
  maintenance:[
    {
      id:uuid(),
      propertyId,
      title:'Tenant reported dripping kitchen tap',
      priority:'Low',
      status:'Open',
      reportedBy:users[3].id,
      createdAt:now
    }
  ],
  reminders:[],
